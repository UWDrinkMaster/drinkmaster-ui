<template>
  <div>
    ...
    <div style="width: 100%; height: 100%; position: relative; background: white">
      ...
      <div style="padding-left: 20px; padding-right: 20px; padding-top: 8px; padding-bottom: 8px; left: 37%; top: 264px; position: absolute; background: linear-gradient(180deg, #F9E8A8 0%, #F4C317 91%); border-radius: 24px; justify-content: flex-start; align-items: center; gap: 8px; display: inline-flex">
